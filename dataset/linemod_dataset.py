...
class LinemodDataset(Dataset):
    def __init__(self, root_dir, split="train", transform=None, img_ext=".png"):
        """
        Args:
        ...
        self.file_ids = [f.stem for f in self.images_dir.glob(f"*{img_ext}")]
        ...
        if label_path.exists():
            ...
            try:
                ...
                if data.size > 0:
                    ...
                    boxes = data[
                        :, 1:
                    ]  # Remaining 4 columns are Coordinates (xc, yc, w, h)
            except Exception:
