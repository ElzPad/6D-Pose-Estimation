...
from .model import ResNetTranslationWithObjectID
...
def main():
    ...
    use_object_id = True
    print("Using ResNetTranslationWithObjectID (object identity conditioning, bbox, diameter)")
    model = ResNetTranslationWithObjectID(
