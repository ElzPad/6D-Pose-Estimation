import torch
from .train import ResNetRotation, ResNetRotationWithObjectID, NUM_OBJECTS

def load_resnet(weights_path, device='cpu', freeze_backbone=False, use_object_id=False):
    """
    ...
    """
    print(f"Loading custom ResNet from {weights_path}...")
